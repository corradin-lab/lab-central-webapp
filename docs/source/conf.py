...
# lab_central_webapp documentation build
...
from lab_central_webapp import __version__ as release

# -- Project information -----------------------------------------------------

project = "lab_central_webapp"
author = "Kedro"
...
htmlhelp_basename = "lab_central_webappdoc"
...
latex_documents = [
    (
        master_doc,
        "lab_central_webapp.tex",
        "lab_central_webapp Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "lab_central_webapp",
        "Project lab_central_webapp codebase.",
        "Data-Science",
    )
]
